...
engine = create_engine('sqlite:///creative.db')
...
new_Book.add_book(new_Book.bookName, new_Book.bookPages, new_Book.bookAuthor)

# Optionally, you can close the session here or later in your code
session.close()
